Feature: 2 Bind governed constraints to the Logical Schema
  ...
  # IT-37R1 — Produce governed Logical Schema bindings
  ...
  # IT-37R2 — Reuse governed Logical Schema identity
  ...
  # IT-37R3 — Reject unresolved or ambiguous bindings
  ...
  # IT-37R4 — Satisfy the Logical Schema binding agent contract

@otdd @validation @report-identity @validation-cycle
...
@otdd-entry-s-01 @user-interface @landing-page @navigation
...
And the report-validation page presents a "Validate" action

@otdd-entry-s-02 @user-interface @demo-mode @disclosure
...
@otdd-entry-s-03 @user-interface @demo-mode @anonymous @disclosure
...
@otdd-entry-s-04 @user-interface @demo-mode @anonymous @cancel
...
@otdd-entry-s-05 @user-interface @demo-mode @anonymous @continue
